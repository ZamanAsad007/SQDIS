...
export class ReportsController {
  ...
  async downloadReport(
    ...
    const orgId = organizationId || user.organizationId;
    const report = await this.reportsService.findById(id, orgId);
    ...
    const filePath = await this.reportsService.getDownloadUrl(id, orgId);
  ...
  async retryReport(
    ...
    const orgId = organizationId || user.organizationId;
    return this.reportsService.retryFailedReport(id, orgId);
  }
  ...
  async deleteReport(
    ...
    const orgId = organizationId || user.organizationId;
    await this.reportsService.delete(id, orgId);
...
export class LeaderboardController {
  ...
  async getLeaderboard(
    ...
    const orgId = organizationId || user.organizationId;
    return this.leaderboardService.getLeaderboard(orgId, query);
  }
  ...
  async getTeamLeaderboard(
    ...
    const orgId = organizationId || user.organizationId;
    return this.leaderboardService.getTeamLeaderboard(orgId, query);
  }
}
